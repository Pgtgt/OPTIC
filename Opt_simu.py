# -*- coding: utf-8 -*-
"""
Created on Sun May 17 19:02:03 2020
...
# grid = pg.GridItem()
#view.addItem(grid)
view.setRange(pg.QtCore.QRectF(-50, -30, 100, 100)) #左上のボックスの　ｘｙ　DxDY?

optics = []
rays = []
m1 = Mirror(r1=-100, pos=(5,0), d=5, angle=-15) #曲率半径？，場所，幅　角度
optics.append(m1)
m2 = Mirror(r1=-70, pos=(-40, 30), d=6, angle=180-15)
optics.append(m2)

m3 = Mirror(r1=-100, pos=(0,0), d=0.001, angle=-15) #曲率半径？，場所，幅　角度
optics.append(m3)
m4 = Mirror(r1=-70, pos=(0,0), d=0.001, angle=90)
optics.append(m4)
...
allRays = []
for wl in np.linspace(355,1040, 25): #nm
    for y in [10]:
...
#view.setAspectLocked()
view.setRange(QtCore.QRectF(500, -50, 500, 200))
# view.setRange(QtCore.QRectF(500, -50, 500, 200))
